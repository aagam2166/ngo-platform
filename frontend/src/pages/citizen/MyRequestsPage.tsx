              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-gray-900 sm:truncate">{req.title}</h3>
                ...
                {/* Bottom metadata row */}
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-3 pt-3 border-t border-gray-50">
                  <span className="text-[10px] sm:text-xs bg-gray-100 text-gray-600 px-2.5 py-1 rounded-full font-medium">
                  ...
                  <Link
                    to={`/requests/${req.id}`}
                    className="text-xs text-orange-500 hover:text-orange-700 font-medium ml-auto sm:ml-auto"
                  >
                    View Details →
                  </Link>
                </div>
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-50 flex items-center justify-between min-h-[32px]">
                    {cancellingId === req.id ? (
                      <div className="flex flex-col sm:flex-row sm:items-center gap-3 w-full">
                        <div className="flex-1 min-w-0">
                          <p className="text-xs text-red-600 font-medium sm:truncate">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          <button
                            ...
                            className="flex-1 sm:flex-none text-xs bg-red-500 hover:bg-red-600 disabled:bg-red-300 text-white px-3 py-1.5 rounded-lg font-semibold transition-colors"
                          >
                          ...
                          <button
                            ...
                            disabled={isCancellingAction}
                            className="flex-1 sm:flex-none text-xs border border-gray-300 text-gray-600 px-3 py-1.5 rounded-lg hover:bg-gray-50 disabled:opacity-50 transition-colors"
                          >
                            No
                          </button>
                        </div>
