                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      {editingId === r.id ? (
                        ...
                        <button
                          onClick={() => { setEditingId(r.id); setEditQty(r.quantity); }}
                          className={`font-semibold hover:text-orange-500 transition-colors ${
                            r.quantity < 10 ? 'text-red-600' : 'text-gray-900'
                          }`}
                        ...
                        >
                          ...
                          {r.quantity < 10 && (
                            <span className="ml-2 text-xs bg-red-100 text-red-600 px-1.5 py-0.5 rounded font-semibold">
                              Low
                            </span>
                          )}
                        </button>
                    ...
                    <td className="px-5 py-4">
                      <span className={`text-sm font-medium ${
                        (r._count?.allocations ?? 0) > 0 ? 'text-orange-600' : 'text-gray-400'
                      }`}>
                      ...
                      {deletingId === r.id ? (
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="text-xs bg-red-500 hover:bg-red-600 text-white px-2.5 py-1 rounded-lg"
                          >
                            Yes
                          </button>
                          <button
                        ...
                        <button
                          onClick={() => { setDeletingId(r.id); setDeleteError(''); }}
